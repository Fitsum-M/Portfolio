          ...
          <div className="w-full md:w-1/2 space-y-8 lg:space-y-12">
            ...
            <div className="space-y-8">
              ...
              <div className="group flex flex-col sm:flex-row items-center sm:items-start gap-4 p-6 rounded-2xl bg-white shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-gray-600 text-base">+2519 37 58 15 37</p>
                </div>
              </div>
            </div>
            <div className="pt-8 border-t border-gray-200">
              ...
              <div className="flex justify-center lg:justify-start space-x-4">
                <a
                  href="https://github.com/Fitsum-M"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/fitsum-mulugeta-417286395"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="mailto:fitsummulugeta22@gmail.com"
